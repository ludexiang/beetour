...
<body>
	...
	<script type="text/javascript" src="/springmvc-mongo/static/js/web/item.js"></script>	
	<section>
	<script>
	...
	<header>
		<div style="text-align: center;color: red;font-size: 20px;">所有项目</div>
	</header>
	<div style="padding-top: 20px;">
		<section>
		<div style="text-align: center;">
		<a style="width:150px;height:50px;font-size:35px;" href="/springmvc-mongo/item/create">增加</a>
		</div>		
		<div id="ajaxData">
